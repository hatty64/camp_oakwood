...
@export var trigger_container:NodePath

@export var trig_container:TriggerContainer
@export var trigger_counter = 0
@export var trig_iter:Dictionary
@export var trigger_timeout:bool = false
@export var trigger_time:float = 0
var trig_collider
var trig_signal

@export var rotating_speed = 0.0
@export var active:bool = true
@export var shared_area_name = "0"
var shared_area
@export var pool_amount:int = 50

@export var r_randomisation_chances:float
@export var r_active_chances:float
@export var r_shared_area_choice:String
@export var r_rotating_variation:Vector3
@export var r_pattern_choice:String
@export var r_start_time_choice:String
@export var r_start_time_variation:Vector3

@export var auto_call:bool = false
