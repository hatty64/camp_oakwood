...
func _process(delta: float) -> void:
	...
	if entered_2 == true:
		Transit.change_scene_to_file("res://scenes/library_top_floor_cutscene.tscn")
...
func _on_cutscene_transit_body_entered(body: Node2D) -> void:
	if body.has_method("player"):
		entered_2 = true


func _on_cutscene_transit_body_exited(body: Node2D) -> void:
	if body.has_method("player"):
		entered_2 = false
